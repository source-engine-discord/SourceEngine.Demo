    ...
    public partial class Collector
    {
        ...
        private void SayText2EventHandler(object sender, SayText2EventArgs e)
        {
            ...
            var feedbackMessage = new FeedbackMessage
            {
                ...
                XLastAlivePosition = playerAlive ? null : player?.LastAlivePosition.X,
                YLastAlivePosition = playerAlive ? null : player?.LastAlivePosition.Y,
                ZLastAlivePosition = playerAlive ? null : player?.LastAlivePosition.Z,
