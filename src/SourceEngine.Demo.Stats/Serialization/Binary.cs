...
namespace SourceEngine.Demo.Stats.Serialization
{
    /// <summary>
    ...
    /// <para>
    /// To prevent a variable from being serialized, decorate it with the [NonSerialized] attribute; cannot be applied to
    /// properties.
    /// </para>
    /// </summary>
