...
namespace SourceEngine.Demo.Stats
{
    public class Debug
    {
        ...
        {
            printMsg(string.Format(msg, args), ConsoleColor.White, DebugLevel.normal, "INFO");
        }

        public static void Success(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.Cyan, DebugLevel.low, "Success");
        }

        public static void Error(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.Red, DebugLevel.low, "Error");
        }

        public static void Warn(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.DarkCyan, DebugLevel.normal, "Warn");
        }

        public static void Headings(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.White, DebugLevel.normal, "", false);
        }

        public static void Blue(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.DarkGray, DebugLevel.normal, "", false, true);
        }

        public static void White(string msg, params object[] args)
        {
            printMsg(string.Format(msg, args), ConsoleColor.White, DebugLevel.normal, "", false, true);
        }
